...
class GMMVAE(pl.LightningModule):
    ...
    def loss_function(self, gex_true, adt_true, gex_dist, adt_dist, z_means, z_sample, normal_rv, guiding_classes, gmm, prefix=""):
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        metrics = self.loss_function(gex_true, adt_true, gex_dist, adt_dist, z_means, z_sample, normal_rv, guiding_classes, gmm)
