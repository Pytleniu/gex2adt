...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default="gmmvae_better_backup", help='Model name')
    parser.add_argument('--output', type=str, default="out_0", help='Name of the output file')
